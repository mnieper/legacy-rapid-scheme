(define-library (rapid generate)   ; TODO: Should be called module.
 ; IDEA:   asmjs -> js
 ;         module -> assemble
 ;         generate -> module
 ;         translate -> generate
  (export
    generate-module at parent-frame-ptr arg local global
  ...
  (begin
    ...
    (define (generate-module global-count block*)
   ...
   (emit-js
    (compile-module
     ;(error (error 
        (generate-module 5
          `((
            (set! ,(local 2 3) ,(string-const "What's up?"))
